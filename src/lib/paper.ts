...
/* Keep this byte-identical with assets/bib/openwam.txt on the personal site
 * and the Citation block in the code repo's README — one entry, three homes. */
export const BIBTEX = `@article{wang2026openwam,
